...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_PRODUCT_INFO_BLOCK_ORDER" => "price,props,sku",
		"DETAIL_PRODUCT_PAY_BLOCK_ORDER" => "quantity,rating,priceRanges,quantityLimit,buttons,price",
		...
		"LIST_META_KEYWORDS" => "-",
		"LIST_PRODUCT_BLOCKS_ORDER" => "quantity,props,price,sku,buttons,quantityLimit",
		...
		"USE_STORE" => "N",
		"COMPONENT_TEMPLATE" => "donna-catalog",
